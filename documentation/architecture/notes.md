...
- Strict Schema Usage `backlogged - for future`
- Schema Descriptor, Field Type, and other schema enhancements `backlogged - for future`
...
- Realtime Log Fetching `backlogged - for future`
...
- CI/CD Pipelines 
- A Monitoring Dashboard (in Container Dashboard) `backlogged - for future`
- MetricRegistry Schema Validation and Definition `backlogged - for future`
- MetricRegistry Data Visualization in Dashboard `backlogged - for future`
- MetricPipes for Easy Analysis of Metrics `backlogged - for future`
- Pretty Print JSON Logs to Prettified logs `backlogged - for future`
...
| Log Fetching or Log Get | In-time/Static Log Fetching | [#17](https://github.com/TanmoySG/logsmith-monitor/issues/17) | v0.1.0-alpha | [logsmith-monitor v0.1.0](https://github.com/TanmoySG/logsmith-monitor/milestone/1) |
